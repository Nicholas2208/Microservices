...
@Tag(
        name = "CRUD REST APIs for Accounts in White Bank",
        description = "CRUD REST APIs in White Bank to CREATE, UPDATE, FETCH AND DELETE account details"
)
@RestController
...
public class AccountController {
    ...
    @Operation(
            ...
            description = "REST API to create new Customer &  Account inside White Bank"
    )
    @ApiResponse(
            responseCode = "201",
