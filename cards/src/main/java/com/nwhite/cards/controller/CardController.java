package com.nwhite.cards.controller;
...
import com.nwhite.cards.dto.ErrorResponseDto;
import com.nwhite.cards.dto.ResponseDto;
...
@Tag(
        name = "CRUD REST APIs for Cards in White Bank",
        description = "CRUD REST APIs in White Bank to CREATE, UPDATE, FETCH AND DELETE card details"
)
@RestController
...
public class CardController {
    ...
    @Operation(
            ...
            description = "REST API to create new Card inside White Bank"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
