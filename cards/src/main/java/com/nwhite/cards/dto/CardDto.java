...
public class CardDto {
    ...
    @NotEmpty(message = "CardType must not be null or empty")
    @Schema(
    ...
    @Schema(
            description = "Total amount limit available on a card", example = "100000"
    )
    private int totalLimit;

    @PositiveOrZero(message = "Total amount must be equal or greater than zero")
    @Schema(
    ...
    @Schema(
            description = "Total available amount on a card", example = "90000"
    )
